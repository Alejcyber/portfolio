...
const experiences = [
  ...
  },
  {
    ...
    points: [
      ...
      "Cliente Farmatodo",
      "Sistema de gestión de anaqueles usando Angular.",
    ],
  },
  {
    title: "Full-Stack Developer",
    ...
    points: [
      "Responsabilidades:",
      "Mantenimiento y creacion de nuevos modulos para un sistema de gestion de importaciones y exportaciones aereas, maritimas y terrestres.",
      "Usando los frameworks Spring Boot y Angular, base de datos MySQL",
    ],
  },
];
